package com.robertovecchio.aribspresentation
...
public inline fun ViewManager.elevationImage(theme: Int = 0) = elevationImage(theme) {}
public inline fun ViewManager.elevationImage(theme: Int = 0, init: ElevationImageView.() -> Unit) = ankoView({ ElevationImageView(it) }, theme, init)

open class ElevationImageView (c:Context): AppCompatImageView(c) {
