...
import it.corelab.studios.airbooks.view.dialog.login.CountryDialog
...
import it.corelab.studios.airbooks.model.interfaces.login.signup.EditTextController
import it.corelab.studios.airbooks.model.interfaces.login.signup.SignUpController
import it.corelab.studios.airbooks.view.anko.layout.login.pages.SignUpUI
...
class SignUpFragment : Fragment(), SignUpController, EditTextController, DialogController {
    ...
    override fun setListeners() {
        ...
        nation.setOnClickListener {
            SignUpFragment.countryDialog = CountryDialog()
            SignUpFragment.countryDialog.show(fragmentManager!!, "Choose your country")
        }
        ...
        signUp.setOnClickListener{
            ...
            if (isCredentialValid) {
                ...
                Log.i("FEED:", email.text.toString() + " " +
                        ...
                        takeIsoNation(SignUpFragment.nation))

                val postSignUp = PostSignUp(email.text.toString(), password.text.toString(), firstName.text.toString(), lastName.text.toString(), takeIsoNation(SignUpFragment.nation))
